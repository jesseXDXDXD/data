...
execute facing entity @n[team=!enemy,tag=!adminfrfr,tag=!notarget] eyes in minecraft:overworld positioned 0.0 0 0.0 run summon marker ^ ^0.5 ^2 {Tags:["direction"]}
